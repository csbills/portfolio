...
export default function Home() {
  return (
    <>
      ...
      <section id="about" className="w-full min-h-screen bg-her1o-pattern bg-cover bg-no-repeat bg-fixed bg-center">
        <div className="max-w-6xl h-screen m-auto flex flex-col justify-center items-start">
          <div className="font-poppins">
            <div className="text-2xl text-gray-900">Hello,</div>
            <div className="text-7xl font-semibold text-gray-900">I'm Caio Henrique</div>
            <div className="text-4xl text-blue-500">Front End Developer</div>
            <div className="text-2xl text-gray-900">From Brazil</div>
